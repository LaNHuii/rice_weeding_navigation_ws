...
| 接口 | 类型 | 发布者 | 消费者 | Phase 1 状态 |
| --- | --- | --- | --- | --- |
| `/clock` | `rosgraph_msgs/msg/Clock` | Gazebo Sim | 全部仿真节点 | 待动态验证 |
| `/rice_weeding/simulation/ground_truth` | `nav_msgs/msg/Odometry` | 仿真真值适配器 | 评测 | 接口占位 |
