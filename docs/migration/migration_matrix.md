...
| --- | --- | --- | --- |
| 工作空间与合同 | BUILT | 4个包被 colcon 发现并构建；根合同测试 `10 passed` | 继续按模块补充动态合同 |
| 车辆描述 | BUILT | canonical profile、Xacro展开、URDF树检查和安装态robot_state_publisher启动通过 | Gazebo生成实体与实车尺寸复测 |
